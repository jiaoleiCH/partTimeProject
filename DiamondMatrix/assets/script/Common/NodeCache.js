...
let prefabInfos = [
    {name:Config.diamondFeild, path:'prefabs/diamondFeild'},
    {name:Config.diamond, path:'prefabs/diamond'},
    {name:Config.dirRect, path:'prefabs/dirRect'},
];
